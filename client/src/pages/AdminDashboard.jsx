    ...
    return (
      <div className="min-h-screen pt-20 pb-24 md:pb-8 flex items-center justify-center">
        <div className="text-center">
          ...
          ></div>
          <p className="text-neutral-600 mt-4">Loading admin dashboard...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        >
          <div>
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-neutral-900 mt-2">
          ...
          {stats.map((stat) => {
            ...
            return (
              <motion.div
                ...
                initial="hidden"
                animate="visible"
                className="bg-white rounded-3xl border border-neutral-100 p-6 shadow-sm"
              >
                <div
                ...
                <p className="text-4xl font-bold text-neutral-900 mt-2">{stat.value}</p>
              </motion.div>
            );
          })}
        </div>
                        ...
                        <td className="px-6 py-5">
                          <div className="flex flex-wrap gap-2">
                            <button
                              ...
                              className="px-3 py-2 rounded-xl text-sm font-semibold border border-neutral-200 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                              {managedUser.role === "admin"
                                ? "Make User"
                                : "Make Admin"}
                            ...
                            <button
                              ...
                              className="px-3 py-2 rounded-xl text-sm font-semibold text-white disabled:opacity-50 disabled:cursor-not-allowed"
                              style={{
            ...
            <div className="bg-white rounded-3xl border border-neutral-100 shadow-sm p-6">
              ...
              <div className="space-y-4">
                {dashboard?.recentUsers?.map((recentUser) => (
                  <div
                    key={recentUser._id}
                    className="p-4 rounded-2xl border border-neutral-100"
                  >
